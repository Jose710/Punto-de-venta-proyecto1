            ...
            <div class="card-body">
                <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                        <div class="text-xs font-weight-bold text-danger text-uppercase mb-1">
                            ...
                            <?php
                                ...
                                ?>
                                  <div class="h5 mb-0 font-weight-bold text-gray-800" id="Cantidad"><?php echo $_SESSION['cancaja']?></div>
                                <?php
                                }else{
                                   ?>
                                   <div class="h5 mb-0 font-weight-bold text-gray-800" id="Cantidad">00</div>
                    ...
                    <div class="col mr-3">
                            ...
                            <button type="button" class="btn btn-warning"  data-toggle="modal" data-target="#cargarcaja">Abrir</button>
                            <button type="button" class="btn btn-danger" data-toggle="modal" data-target="#cerrarcaja">Cerrar</button>
                        </div>
                    <div class="col-auto">
                        <i class="fas fa-money-bill fa-2x text-gray-300"></i>
                    </div>
