    ...
    <div class="card mb-2">
        <div class="card-body">
            ...
            <div class="row">
                ...
                <div class="col-md-2">
                    <label for="">Impuestos<span class="text-danger">*</span></label>
                    <div class="input-group mb-3">
                        <div class="input-group-prepend">
                            <span class="input-group-text"><i class="fas fa-barcode"></i></span>
                        </div>
                        <input type="text" class="form-control" id="impuesto" name="impuesto" placeholder="0.00">
                    </div>
                </div>

                <div class="col-md-2">
                    <label for="">No Serie<span class="text-danger">*</span></label>
                    <div class="input-group mb-3">
                        <div class="input-group-prepend">
                            <span class="input-group-text"><i class="fas fa-barcode"></i></span>
                        </div>
                        <input type="text" class="form-control" id="serie" name="serie" placeholder="0.00">
                    </div>
                </div>
                ...
                <div class="col-md-4">
                    ...
                    <div class="input-group mb-3">
                            <div class="input-group-prepend">
                                <span class="input-group-text"><i class="fas fa-list mr-1"></i></span>
                            </div>
                            <select id="categoria" name="categoria" class="form-control">
                                <option value="Alimentoenlatado">Alimento enlatado</option>
                                ...
                                <option value="Snack">Snack y golosinas</option>
                            </select>
                        </div> 
                </div>
