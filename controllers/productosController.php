...
switch ($option) {
    ...
    case 'save':
        ...
        if ($id_product == '') {
            ...
            if (empty($consult)) {
                $result = $productos->saveProduct($barcode, $nombre, $precio, $impuesto, $serie, $categoria, $stock);
                if ($result) {
            ...
            $result = $productos->updateProduct($barcode, $nombre, $precio, $impuesto, $serie, $categoria, $stock, $id_product);
            if ($result) {
