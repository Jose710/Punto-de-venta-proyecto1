...
class Ventas{
    ...
    public function saveVenta($id_cliente, $descuento, $subtotal, $total, $mayor, $metodo, $fecha, $id_user)
    {
        $consult = $this->pdo->prepare("INSERT INTO ventas (id_cliente, descuento, subtotal, total, mayorista, metodo, fecha, id_usuario) VALUES (?,?,?,?,?,?,?,?)");
        $consult->execute([$id_cliente, $descuento, $subtotal, $total, $mayor, $metodo, $fecha, $id_user]);
        return $this->pdo->lastInsertId();
    }
 
    //Agregado
    public function InsertarMovimiento($codigo_caja, $idusuario, $fechaAp, $tipo_movimiento, $valor, $Estado ){
